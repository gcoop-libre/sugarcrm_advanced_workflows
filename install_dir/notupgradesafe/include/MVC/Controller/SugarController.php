...
class SugarController{
	...
	protected function post_save(){
        ...
        ## Verificar que tengo workflow
        ## Si tengo, continuarlo
        
        $id_workflow = Workflow::get_workflow_id($this->bean);

        if (! is_null($id_workflow))
        {
            $object = loadBean('Executions');
            $object->ejecutar($this->bean, $id_workflow);
        }
